...
from app.dependencies import ChairServiceDep, CurrentUserDep, require_role
from app.models import User, UserRole
from app.schemas.chair import ArxivIngestRequest, ChairCreate, ChairDocumentOut, ChairOut, ChairPatch
