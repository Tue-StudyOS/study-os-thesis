...
**Date:** 2026-06-27
**Ground truth:** skills/tests/eval_ground_truth/medicine.md (6 chairs)
...
|---|---|---|---|
| Skill (find-university-chairs) | 5 | 6 | 83% |
| Baseline (plain Claude) | 0 | 6 | 0% |
| **Skill advantage** | | | **+83%** |
...
*(none — 0 chairs identified by name)*

## Interpretation

Skill arm recall: **83%** vs. baseline: **0%** — gap: **+83%**.
High-relevance ratio (chairs directly matching neurodegeneration interest): skill 40% vs. baseline 0%.
